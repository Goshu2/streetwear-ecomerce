    ...
    <div className="flex items-center gap-2">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56">
          ...
          {loading ? (
            <div className="px-2 py-1 text-sm">Зарежда категории...</div>
          ) : categories.length === 0 ? (
          ...
          <DropdownMenuSeparator />
          <DropdownMenuLabel>Брандове</DropdownMenuLabel>

          {loading ? (
            <div className="px-2 py-1 text-sm">Зарежда брандове...</div>
          ) : brands.length === 0 ? (
            <div className="px-2 py-1 text-sm">Няма налични брандове</div>
          ) : (
            brands.map((brand) => (
              <DropdownMenuCheckboxItem
                key={brand.id}
