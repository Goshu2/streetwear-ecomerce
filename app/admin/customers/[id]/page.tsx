        ...
        <div className="flex flex-col">
          ...
          <main className="flex-1 p-6">
            ...
            <Tabs defaultValue="orders" className="mt-6">
              <TabsList>
                <TabsTrigger value="orders">История на поръчките</TabsTrigger>
                <TabsTrigger value="addresses">Адреси</TabsTrigger>
                <TabsTrigger value="notes">Забележки</TabsTrigger>
              </TabsList>
                  ...
                  <CardContent>
                    {orders.length === 0 ? (
                      <div className="text-center py-6">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">Клиентът все още няма поръчки.</p>
                      </div>
                    ) : (
