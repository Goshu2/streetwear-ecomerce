          ...
          <main className="flex-1 p-6">
            <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
              <div className="flex items-center justify-between mb-6">
                <TabsList>
                  <TabsTrigger value="all">Всички продукти</TabsTrigger>
                  <TabsTrigger value="active">Активни</TabsTrigger>
                  <TabsTrigger value="out-of-stock">Няма наличност</TabsTrigger>
                  <TabsTrigger value="featured">Представено</TabsTrigger>
                </TabsList>
